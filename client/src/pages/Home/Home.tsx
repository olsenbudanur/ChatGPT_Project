      ...
      <S.Sec1Wrapper>
        <S.TextLoginWrapper>
          <S.TextWrapper>
            <S.Title>
              <TypeAnimation
                sequence={["Too Tired to Write Your College Essay?"]}
                speed={80}
              />
            </S.Title>
            <S.SubTitle>
              Write your essay using the same AI model that powers ChatGPT{" "}
              <S.openAILogo src={String(openAI)} /> in a matter of minutes
              {blink ? "!" : ""}
            </S.SubTitle>

            <S.Title>Try Now!</S.Title>
            <S.SubTitle>
              Enter some basic information, and watch the AI write your essay!
            </S.SubTitle>
          </S.TextWrapper>
          <S.LoginWrapper>
            {!currentUser && (
            ...
            {emailExists && (
              <>
                <Alert severity="info">
                  This email already exists. Please log in through the link sent
                  to the email. (Make sure to check spam)
                </Alert>
              </>
            )}
            {loginError && (
